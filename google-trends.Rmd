...
**Question 2.2. Do you think volume of Google searches is a good metric of social media use?**
  Yes, because it represents the frequency people search a topic
**Question 2.3. Come up with a set of search terms that you think would make an interesting comparison, and describe your results here.**
  I put in UIUC, USC, UNC and UCI as my searches. it turns out that it fluctuates a lot. 
...
##the function returns the data status of words "katrina" and "harvey" on web searching in US from 2000 to 2021
...
```{r}
holidays <- gtrends(c("spring break","vacation"), time = "2008-01-01 2018-01-01", gprop = "web", geo = c("US"))
```
...
In the graph, we see that the curves of spring break and vacation are correlated and have the same tendencies. Yes, I do. 
...
```{r}
guns <- gtrends(c("guns"), time = "all", gprop = "web", geo = c("US"))
```
...
Location in gunsInterestByRegion and Region in statesMap can be used as keys to join. Yes, they are identical.
...
```{r}
gunsMerged <- merge(gunsInterestByRegion, statesMap, by = "region")
```
...
gunsMerged %>%
  ...
  geom_polygon(aes(group =group, fill = log(hits) )) +
  coord_fixed(1.3) +
  scale_fill_distiller(palette = "Reds") +
  ggtitle("Google search interest for guns in each state in US")
```
**Question 3.9. What do you find about the search interests of `guns` in different states? How do you explain your findings?**
The darker the color is, the less search frequency of "guns" is, which inderectly infers that the area is safe. Midwest states are most dangerous, which fits the reality. 
...
<script type="text/javascript" src="https://ssl.gstatic.com/trends_nrtr/2790_RC02/embed_loader.js"></script> <script type="text/javascript"> trends.embed.renderExploreWidget("TIMESERIES", {"comparisonItem":[{"keyword":"spring break","geo":"US","time":"2008-01-01 2018-01-01"},{"keyword":"vacation","geo":"US","time":"2008-01-01 2018-01-01"}],"category":0,"property":""}, {"exploreQuery":"date=2008-01-01%202018-01-01&geo=US&q=spring%20break,vacation","guestPath":"https://trends.google.com:443/trends/embed/"}); </script> 
...
<script type="text/javascript" src="https://ssl.gstatic.com/trends_nrtr/2790_RC02/embed_loader.js"></script> <script type="text/javascript"> trends.embed.renderExploreWidget("TIMESERIES", {"comparisonItem":[{"keyword":"internet","geo":"US","time":"2008-01-01 2018-01-01"},{"keyword":"tv","geo":"US","time":"2008-01-01 2018-01-01"},{"keyword":"radio","geo":"US","time":"2008-01-01 2018-01-01"}],"category":0,"property":""}, {"exploreQuery":"date=2008-01-01%202018-01-01&geo=US&q=internet,tv,radio","guestPath":"https://trends.google.com:443/trends/embed/"}); </script> 
